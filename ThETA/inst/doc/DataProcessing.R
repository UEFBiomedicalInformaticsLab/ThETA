...
## ---- load_theta, cache.lazy = TRUE, echo = TRUE-------------------------
library(ThETA)
data(gtexv7_zscore)
data(ppi_strdb_700)
data(dis_vrnts)
...
## ---- load_spa, cache.lazy = TRUE, echo = TRUE, message = FALSE----------
...
T2DM_tiss_zscore <- dis.rel.tissues(disease_genes = T2DM_genes$entrez, 
                                      ...
                                      thr = 1, top=0, rand = 1000, verbose = T) # rand = 10000 is higlhy recommended

## ---- tab_t2d_all, cache = TRUE, echo = FALSE----------------------------
library(kableExtra)
...
#  
#  tissue_score <- list.tissue.specific.scores(disease_gene_list = sapply(dis_vrnts[idx],'[[',1) ,
#                                              ppi_network = ppi_strdb_700, directed_network = F,
#                                              tissue_expr_data = gtexv7_zscore,
#                                              dis_relevant_tissues = disease_tissue_zscores$z[idx,],
#                                              W = centrality_score$borda.disc, cutoff = 1.6,
#                                              verbose = FALSE, parallel = 30)
