...
It requires 5 inputs: a list of sets of known target-disese associations, efficacy estimates and the columns that are used to indicate the entrez gene IDs, the disease IDs (EFO-id) and the efficayc estimates. 
